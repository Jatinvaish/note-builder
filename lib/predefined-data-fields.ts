...
export const PREDEFINED_DATA_FIELDS: DataField[] = [
  ...
  // Appointment
  { id: "admission_date", label: "Admission Date", category: "Admission", actions: { type: 'API_CALL', api_call_in_page: true, api: 'user/patient-info', oncallback_autofill_value: true }, call_time: { on_render_page: true, on_click_element: false }, autofill_after_value_get: true, depend_value_on_other: false, group_of: { group_auto_fill_input: false, api_group_available: false, model_group_available: false, group_autofill_ids: [] } },
  ...
  // New Global/Patient Fields for Template Use
  { id: "patient_age_gender", label: "Age / Gender", category: "Patient Info", actions: { type: 'API_CALL', api_call_in_page: true, api: 'user/patient-info', oncallback_autofill_value: true }, call_time: { on_render_page: true, on_click_element: false }, autofill_after_value_get: true, depend_value_on_other: false, group_of: { group_auto_fill_input: false, api_group_available: false, model_group_available: false, group_autofill_ids: [] } },
  { id: "note_date_time", label: "Note Date & Time", category: "Patient Info", actions: { type: 'API_CALL', api_call_in_page: true, api: 'user/patient-info', oncallback_autofill_value: true }, call_time: { on_render_page: true, on_click_element: false }, autofill_after_value_get: true, depend_value_on_other: false, group_of: { group_auto_fill_input: false, api_group_available: false, model_group_available: false, group_autofill_ids: [] } },
]
